...
/**
 * DashboardContent handles the main logic and UI of the dashboard.
 * It uses useSearchParams() and must be wrapped in a Suspense boundary.
 */
function DashboardContent() {
  ...
  const PRIMARY_STATS = [
    { id: "occupied", label: "Rooms Occupied", value: stats.occupied.toString(), icon: Users, change: "Live", trend: "neutral" as const },
    { id: "vacant_ready", label: "Vacant Ready", value: stats.vacantReady.toString(), icon: ShieldCheck, change: "Rooms", trend: "up" as const },
    { id: "revenue", label: "Today's Revenue", value: `₹${todayRevenue.toLocaleString()}`, icon: TrendingUp, change: "+12%", trend: "up" as const },
    { id: "arrivals", label: "Today's Arrival", value: (todayArrivals?.length || 0).toString(), icon: CalendarCheck2, change: "Confirmed", trend: "neutral" as const },
  ];
 ...
 * Wraps DashboardContent in AppLayout and Suspense.
 */
